<template>
  <nav class="hidden md:flex space-x-10 px-6">
    <nuxt-link to="/services" class="text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
      Services
    </nuxt-link>
