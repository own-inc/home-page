<template>
  <aside class="flex flex-col pr-8 justify-center h-full z-40">
    <a class="w-10" href="/">
      <svg
        ...
        focusable="false"
        role="img"
        class="iconify iconify--bx z-50 hover:text-gray-800"
    ...
    <a class="w-10 mt-8 hover:text-gray-800" href="/">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        aria-hidden="true"
    ...
    <a class="w-10 mt-8 hover:text-gray-800" href="/">
      <svg
        ...
        viewBox="0 0 24 24"
        style="transform: rotate(360deg);"
      ><path d="M20 4H6c-1.103 0-2 .897-2 2v5h2V8l6.4 4.8a1.001 1.001 0 0 0 1.2 0L20 8v9h-8v2h8c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm-7 6.75L6.666 6h12.668L13 10.75z" fill="currentColor" /><path d="M2 12h7v2H2zm2 3h6v2H4zm3 3h4v2H7z" fill="currentColor" /></svg>
    </a>
  </aside>
</template>
